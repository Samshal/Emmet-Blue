...
/**
 * class DeleteAccountants.
 *
 * DeleteAccountants Controller
 *
 * @author Bardeson Lucky <flashup4all@gmail.com>
 * @since v0.0.1 15/06/2016 14:20
 */
class DeleteAccountant
{
	/**
	 * delete method
	 *
	...
	public static function delete(int $accountantId)
	{
		...
		try
		{
			$deleteAccountant = (DBConnectionFactory::getConnection())->query((string)$deleteBuilder);

			DatabaseLog::log(Session::get('USER_ID'), Constant::EVENT_DELETE,'Account', 'Accountant', (string)$deleteAccountant);
